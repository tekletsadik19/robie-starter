...
abstract class $ThemeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ThemeMode themeMode, bool isSystemTheme});
}
...
class _$ThemeStateImpl implements _ThemeState {
  const _$ThemeStateImpl({required this.themeMode, this.isSystemTheme = false});
  ...
  @override
  String toString() {
    return 'ThemeState(themeMode: $themeMode, isSystemTheme: $isSystemTheme)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, themeMode, isSystemTheme);
...
abstract class _ThemeState implements ThemeState {
  const factory _ThemeState(
      ...
      final bool isSystemTheme}) = _$ThemeStateImpl;
